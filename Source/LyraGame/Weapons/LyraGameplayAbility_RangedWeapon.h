...
protected:
	...
	// Called when target data is ready. Ranged-weapon Blueprints override this to apply
	// hit effects; ULyraGameplayAbility_ProjectileWeapon overrides it in C++ to spawn projectiles.
