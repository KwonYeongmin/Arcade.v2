...
void ULyraGameplayAbility_RangedWeapon::OnRangedWeaponTargetDataReady_Implementation(const FGameplayAbilityTargetDataHandle& /*TargetData*/)
{
	// Base implementation does nothing. Ranged-weapon Blueprints override the event to apply
	// hit effects; ULyraGameplayAbility_ProjectileWeapon overrides _Implementation to spawn projectiles.
}
