...
namespace LyraGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Flight_Ascend,  "InputTag.Flight.Ascend",  "Flight ascend input.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Flight_Descend, "InputTag.Flight.Descend", "Flight descend input.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Vehicle_Throttle, "InputTag.Vehicle.Throttle", "Vehicle throttle/brake axis.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Vehicle_Steer,    "InputTag.Vehicle.Steer",    "Vehicle steering axis.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Vehicle_Dismount, "InputTag.Vehicle.Dismount", "Vehicle dismount input.");
