...
public:
	...
	// Returns ACharacter::GetMesh(), or the owner's first skeletal mesh for APawn-based characters.
	USkeletalMeshComponent* GetParentMeshComponent() const;

	// Returns the scene component to attach the spawned actors to
	// Uses the body mesh when available, otherwise the root component.
	...
	/** Sets the fallback body mesh used when no cosmetic body-style rule matches. */
	void SetDefaultBodyMesh(USkeletalMesh* InDefaultMesh) { BodyMeshes.DefaultMesh = InDefaultMesh; }
